...
export default function MainLayout({
  ...
  return (
    <MainContextWrapper>
      <div className="h-screen grid lg:grid-cols-[5em_minmax(30em,_1fr)_minmax(min-content,_28em)] sm:grid-cols-[5em_minmax(22em,_1fr)] grid-cols-1 grid-rows-1 w-full">
        <LeftSideBar key={"jrblibrbiyrugv"} />

        <div key={"ojuerbpiuqeyvfrnoi"} className="flex flex-col flex-1">
          <MainNavBar />
          <div className="px-4 py-4 pb-24 overflow-y-scroll sm:px-7">
            {children}
          </div>
          <BottomNavigation />
        </div>
